...
### Resolving Issues and Submitting Pull Requests
  ...
  6. When you are all nished with these changes, you are ready to push them to your upstream fork of Shakespeare's repository. 
...
the heading Comparing changes.
    ...
    (b) If GitHub is not able to merge your changes automatically, you will see instead the message Click the View Pull Request button, and in the new page, click the gray Resolve conflicts button.
