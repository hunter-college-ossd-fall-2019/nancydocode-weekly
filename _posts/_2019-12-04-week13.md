...
- Would you want to work in a company that only produced open source software? Why or why not? What would your dream job be? How would you like to see the business of software production in ten years?
  ...
  I would like to work in a company that only produced open source softwares. Because I can work for me and at the same time for others. How small it will be, anyway it will be awesome to feel that being one of people who try to make better world.
  Looking back the past 10 years, we have achieved so much. 20 years ago, there were only few people used internet. Now, almost everyone can access to it using computers and smartphones. At first, I thought that big companies will
